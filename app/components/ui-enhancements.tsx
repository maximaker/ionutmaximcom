...
export function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`bg-card/80 backdrop-blur-sm border border-border hover:border-accent/50 text-foreground p-3 rounded-full shadow-lg transition-all hover:shadow-xl ${className}`}
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 50% 50%, rgba(255, 122, 16, 0.1) 0%, transparent 80%)',
